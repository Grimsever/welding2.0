...
namespace WeldingV2._0.Controllers
{
    public class MachinesController : Controller
    {
        ...
        {
            var weldingContext = _context.Machines.Include(m => m.MachineData).Include(m => m.Task);
        ...
        {
            ViewData["MachineDataId"] = new SelectList(_context.MachineDatas, "Id", "Id");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,MachineDataId,TaskId")] Machine machine)
        {
            if (id != machine.Id)
            {
                return NotFound();
